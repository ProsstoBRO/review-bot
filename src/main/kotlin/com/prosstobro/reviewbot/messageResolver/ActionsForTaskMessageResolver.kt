...
@Component
class ActionsForTaskMessageResolver(val jiraTaskRepository: JiraTaskRepository, val keyboardUtils: KeyboardUtils): MessageResolver {
    ...
    override fun processAndCreateAnswer(request: TgRequest): List<TgResponse> {
        ...
        return if (NOT_APPROVED == task.status)
